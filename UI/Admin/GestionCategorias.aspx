<%@ Page Title="Admin - Categorias" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="GestionCategorias.aspx.cs" Inherits="UI.Admin.GestionCategorias" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container mt-4">
        ...
        <div class="mb-3">
            <asp:Button ID="btnAbrirAgregar" runat="server" Text="Agregar Categoría" CssClass="btn btn-outline-primary" OnClick="btnAbrirAgregar_Click" />
        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="lblModalTitulo" runat="server">Detalle Categoría</h5>
                </div>
